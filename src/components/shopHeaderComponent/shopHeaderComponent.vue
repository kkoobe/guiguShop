        ...
        <div class="shop-content"> 
            ...
            <div class="header-content" > 
                ...
                <div class="shop-message"> 
                    ...
                    <span class="shop-message-detail"> {{shopInfo.description}} <span>约 {{shopInfo.deliveryTime}} 分钟</span> </span> 
                    <span class="shop-message-detail">距离 {{shopInfo.distance}}</span> 
                </div> 
            </div> 
        </div> 
        <div class="shop-header-discounts" v-if="shopInfo.supports" @click="toggleShowSupports"> 
            ...
            <div class="shop-brief-modal" v-show="showShop"> 
                <div class="brief-modal-content"> 
                    ...
                    <ul class="brief-modal-msg"> 
                        <li><h3>{{shopInfo.foodScore}}</h3> <p>评分</p></li> 
                        <li><h3>{{shopInfo.deliveryCount}}单</h3> <p>月售</p> </li> 
                        <li><h3>{{shopInfo.description}}</h3> <p>约{{shopInfo.deliveryTime}}分钟</p> </li> 
                        <li><h3>{{shopInfo.deliveryPrice}} 元</h3> <p>配送费用</p> </li> 
                        <li><h3>{{shopInfo.distance}}</h3> <p>距离</p> </li> 
                    </ul> 
                    <h3 class="brief-modal-title"><span>公告</span></h3> 
                    <div class="brief-modal-notice">{{shopInfo.bulletin}} </div> 
                    <div class="mask-footer"> 
                        <span class="iconfont icon-close" @click="toggleShowShop"></span> 
                    </div> 
                </div> 
...
export default {
    ...
    methods:{
        toggleShowShop:function(){
            this.showShop=!this.showShop
        },
        toggleShowSupports:function(){
