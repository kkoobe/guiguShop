  ...
  <div class="shop-info"> 
    <div class="info-content"> 
      ...
      <section class="section"> 
        ...
        <div class="activity-sweper">
          <div class='activity'>
            <div :class="{'activity-item':true, 'activity-green':support.type==0,'activity-red':support.type==1,'activity-orange':support.type==2}" v-for="(support,index) in shopInfo.supports" :key="index"> 
      ...
      <section class="section"> 
        ...
        <div class="pic-wrapper"> 
          <ul class="pic-list" ref="picUl"> 
            <li class="pic-item" v-for="(img,index) in shopInfo.pics" :key="index"> 
...
export default {
  ...
  methods:{
    _initScroll(){
      ...
      console.log(ulObj);
      let liListObj=ulObj.children;
      console.log(liListObj)
      let width=Array.from(liListObj).reduce((sumWidth,current)=>{
        sumWidth+=120+6
        return sumWidth
      },0);
      width-=6;
      ulObj.style.width=width+'px';
      // 为图片添加水平滚动
